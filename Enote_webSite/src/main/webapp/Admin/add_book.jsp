			...
			<div class="col-md-4 offset-md-4">
				<div class="card">
					...
					<form action="../adminAddBookServlet" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="inputStare">Book Categories</label>
							<select id="inputStare" name="booktype" class="form-control">
								<option selected>Select</option>
								<option value="new">New Books</option>
								<option value="old">Old Books</option>
								<option value="recent">Recent Books</option>
							</select>
						</div>
						...
						<button type="submit" class="btn btn-prinary">Add</button>
					</form>	
					</div>
				</div>
			</div>
